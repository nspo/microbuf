...
[idx, err, value] = microbuf.parse_uint(bytes, length(bytes), 8, 1);
...
[idx, err, value] = microbuf.parse_uint(bytes, length(bytes), 16, 1);
...
[idx, err, value] = microbuf.parse_uint(bytes, length(bytes), 32, 1);
...
[idx, err, value] = microbuf.parse_uint(bytes, length(bytes), 64, 1);
